...
* **get_similar_units_by_image_url Tool:** Use the tool `get_similar_units_by_image_url` to perform a visual similarity search using a given image URL. It will return up to 3 detailed records of visually similar items.
* **Visual vs. Semantic Similarity Caveat:** The results from `get_similar_units_by_image_url` are strictly for orientation. They will likely NOT show the exact item you are examining. You MUST weight your own morphological analysis of the original image higher than the retrieved visually similar items.
